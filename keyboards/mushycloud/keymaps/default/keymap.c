...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_SPC,     KC_SPC,   KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_ENT,     \
                                   KC_LALT, LOWER,   KC_LGUI, FN,         FN,       KC_RGUI, RAISE,   KC_RALT                                 \
    ),
    [_LOWER] = LAYOUT(
                 KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_TRNS,    KC_TRNS,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0,                 \
        KC_GRV,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,    KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  KC_BSLS,    \
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,    KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_MINS,  KC_EQL,     \
    ...
    [_FN] = LAYOUT(
        ...
        KC_GRV,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,    KC_HOME,  KC_END,  KC_PGUP, KC_PGDN, KC_UP,   KC_TRNS,  KC_TRNS,    \
